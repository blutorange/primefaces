import { getWidgetIfPresent } from "./core.widget.registry";
 ...
 */
export class DynamicOverlayWidget extends BaseWidget {
    ...
    init(cfg, overlay, overlayId, target) {
        ...
        var ignoreAppendTo = Dialog !== undefined && this instanceof Dialog;
        if (!ignoreAppendTo) {
 ...
 *
 * ```javascript
 * import { DeferredWidget } from '@primefaces/primefaces';
 * class MyWidget extends DeferredWidget {
 *   init(cfg) {
 *     super.init(cfg);
 *
 *     // more code if needed
