...
export class Core {
     ...
     */
    readonly VIEW_STATE: string = "javax.faces.ViewState";

    /**
     * Name of the POST parameter with the current client window.
     */
    readonly CLIENT_WINDOW: string = "javax.faces.ClientWindow";

    /**
     * Name of the POST parameter that contains the view root.
     */
    readonly VIEW_ROOT: string = "javax.faces.ViewRoot";
     ...
     */
    readonly RESOURCE_IDENTIFIER: string = 'javax.faces.resource';
