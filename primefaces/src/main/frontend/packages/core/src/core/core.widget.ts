...
export class BaseWidget<Cfg extends BaseWidgetCfg = BaseWidgetCfg>  {
     ...
     */
    destroyListeners: PrimeType.widget.DestroyListener<BaseWidget>[] = [];
     ...
     */
    refreshListeners: PrimeType.widget.RefreshListener<BaseWidget>[] = [];
     ...
     * created on the server by the `javax.faces.render.Renderer` for this component.
     */
...
export class DynamicOverlayWidget<Cfg extends DynamicOverlayWidgetCfg = DynamicOverlayWidgetCfg> extends BaseWidget<Cfg> {
    ...
    enableModality(overlay?: JQuery | null): void {
        ...
        this.modalOverlay = utils.addModal(this,
            target,
            $.proxy(function() {
